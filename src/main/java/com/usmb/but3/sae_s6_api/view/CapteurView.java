...
class CapteurEditor extends Dialog {
    ...
    public CapteurEditor(CapteurService capteurService, MarqueService marqueService) {
        ...
        VerticalLayout layout = new VerticalLayout(nom, description, reference, hauteur, longueur, largeur, urlImg, marque, new HorizontalLayout(save, cancel));
        add(layout);

        binder.forField(nom).asRequired("Champ obligatoire").bind(Capteur::getNom, Capteur::setNom);
        ...
        binder.forField(urlImg).bind(Capteur::getUrlImg, Capteur::setUrlImg);
        ...
        binder.forField(marque).asRequired("Choisir une marque").bind(Capteur::getMarque, Capteur::setMarque);
